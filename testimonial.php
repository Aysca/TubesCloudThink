...
if(isset($_POST['submit'])){
    if($_SESSION['status_login'] != true ){
        ...
        $testi = $_POST['testi'];
        $testimoni_image = $_SESSION['u_global']->profile_picture; // Mengambil gambar dari session

        $insert = mysqli_query($conn,"INSERT INTO testimoni VALUES (
            null,
            '".$name."',
            '".$address."',
            '".$testi."',
...
?>
    ...
    <?php
    // Query untuk mengambil data testimoni dari tabel
    $query = mysqli_query($conn, "SELECT * FROM testimoni");

    // Looping untuk menampilkan setiap testimoni dalam carousel
    ...
    <div class="testimonial-item text-center">
        <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="colorlib-regform-7/user/<?php echo $image; ?>" style="width: 100px; height: 100px" />
        <div class="testimonial-text rounded text-center p-4">
            <p>" <?php echo $testimonial; ?> "</p>
            <h5 class="mb-1"><?php echo $name; ?></h5>
            <span class="fst-italic"><?php echo $location; ?></span>
        </div>
    </div>
    <?php
    }
            ...
            <div class="h-100 bg-secondary p-5">
              <form method="POST" >
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input Required type="text" class="form-control bg-light border-0" id="address" name="address"
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input Required type="text" class="form-control bg-light border-0" id="testi" name="testi"
...
<div></div>
                    ...
                    <div class="col-12">
                      <label for=""></label>
                        <input class="btn btn-primary px-5" style="margin-top : 20px;" href="testimonial.php" type="submit" value="submit" name="submit" id="submit"
                       >
